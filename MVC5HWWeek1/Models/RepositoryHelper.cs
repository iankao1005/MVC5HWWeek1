namespace MVC5HWWeek1.Models
{
	public static class RepositoryHelper
	{
		...
		public static view客戶相關資訊Repository Getview客戶相關資訊Repository()
		{
			var repository = new view客戶相關資訊Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static view客戶相關資訊Repository Getview客戶相關資訊Repository(IUnitOfWork unitOfWork)
		{
			var repository = new view客戶相關資訊Repository();
